        ...
        <div className="hidden items-center gap-1 md:flex">
          {links.map((link) => (
            <Link
              ...
              href={link.href}
              className={cn(
                "rounded-full px-4 py-2 text-sm font-medium transition-colors duration-200 hover:bg-muted hover:text-accent-bright",
          ...
          <div className="mx-auto flex max-w-7xl flex-col gap-1 px-5 py-4">
            {links.map((link) => (
              <Link
                ...
                onClick={closeMenu}
                className={cn(
                  "rounded-lg px-4 py-3 text-sm font-medium transition-colors duration-200 hover:bg-muted hover:text-accent-bright",
                  pathname === link.href && "text-accent-bright"
                )}
              >
                {link.label}
