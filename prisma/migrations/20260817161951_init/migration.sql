...
-- CreateEnum
CREATE TYPE "PortfolioCategory" AS ENUM ('WEDDING', 'PREWEDDING', 'PORTRAIT', 'EVENT', 'PRODUCT', 'OTHER');
...
-- CreateIndex
CREATE UNIQUE INDEX "PortfolioImage_publicId_key" ON "PortfolioImage"("publicId");
